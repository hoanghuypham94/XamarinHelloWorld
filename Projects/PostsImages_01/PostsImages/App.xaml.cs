...
namespace PostsImages
{
    public partial class App : PrismApplication
    {
        ...
        {
            InitializeComponent();
            NavigationService.NavigateAsync(new System.Uri("/Splash_screen", System.UriKind.Absolute));
        }
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterForNavigation<Splash_screen, SplashScreenViewModel>();
            containerRegistry.RegisterForNavigation<CreditCardPageView, CreditCardPageViewModel>();
